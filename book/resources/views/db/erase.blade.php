...
<body>
 ...
 @if(isset($record))
    <form action="/db/erase2" method="post">
        ...
        {{$record->id}}
        title<input type="text"name="title" value="{{$record->title}}"><br>
        author<input type="text" name="author"value="{{$record->author}}"><br>
        publisher<input type="text"name="publisher" value="{{$record->publisher}}"><br>
        isbn<input type="text" name="isbn"value="{{$record->isbn}}"><br>
